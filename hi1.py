...
class App(QMainWindow):
    ...
    def invalid_path_alert_message(self):
        ...
        messageBox.setText("Le fichier / direction séléctionné n'est pas valid. Veuillez choisir un fichier valide.")
        messageBox.exec()
...
# work 
    def closeEvent(self, event):
        ...
        message = "Alerte !!\n\nISi vous quittez sans sauvegarder le projet actuel, vous risquez de perdre touyes les modifications apportées.\n\nVoulez-vous rnregistrer le fichier avant de quitter?"
    ...
    def analyse_lex(self):
        ...
        if editorValue == "":
            ...
            QMessageBox.warning(self, 'err', "Vous n'avez rien écrit", QMessageBox.Close, QMessageBox.Close)
        else:
            ...
            QMessageBox.question(self, 'Output Message', "entité lexicalement correcte :)\nvouz pouvez voir la liste des tokens\nlà-dessous",QMessageBox.Ok,QMessageBox.Ok)
